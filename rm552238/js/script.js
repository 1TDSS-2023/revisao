...
//Declarando um array de objjetos e suas propriedades
// let alunos = [
//     {nome : "João", nota: 8, disciplina: "Português"},
//     {nome : "Maria", nota: 9, disciplina: "Matemática"},
//     {nome : "José", nota: 8, disciplina: "História"}
...
// //imprimmir array de objetos no forEach
// alunos.forEach(aluno => {
//     console.log(aluno);
// })
...
//Removendo um elemento do array com shift
alunos.shift();
//Imprimir array de nomes de alunos
console.log(alunos);
...
//Remover elementos do array com splice
alunos.splice(2, 2);
